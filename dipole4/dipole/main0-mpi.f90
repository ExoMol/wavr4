...
if(proc_id == 0) write(u6,'(" INPUT DIPOLE: ",/)')
...
if(jr1 > 0 .OR. jr2 > 0) then
  if(proc_id == 0) write(6,*) ' INPUT error: J cannot be greater than 0'
  stop
endif
...
do ii1=1,nstates1
  do ii2=1,nstates2
    ...
    if(proc_id == 0) write(u6,'(i4,"<-",i4,f12.4,es16.4)') ii1,ii2, e1(ii1)-e2(ii2),dt_buffer(ii1,ii2)
  enddo
enddo
