...
!  .. USE STATEMENTS ..
   ...
   ! USE F77_LAPACK, ONLY: DSYEVD
   ! USE F77_LAPACK, ONLY: ILAENV
   USE SUNPERF, ONLY: DSYEVD, ILAENV
!
...
!  .. LOCAL SCALARS ..
   ...
   INTEGER :: ISTAT, ISTAT1, LMWORK, NB, itmp
   INTEGER(8) :: N, LINFO, LD, LIWORK, LWORK, itmp1, ILAENV_64
!  .. LOCAL ARRAYS ..
...
!  .. DETERMINE THE WORKSPACE
      ...
      ELSE
         ...
         LIWORK = 1
      END IF
      itmp1 = ILAENV_64( 1_8, BSNAME, LUPLO, N, -1_8, -1_8, -1_8 )
      NB = itmp1
...
!        .. CALL LAPACK77 ROUTINE
         CALL DSYEVD_64( LJOBZ, LUPLO, N, A, LD, W, WORK, LWORK, &
                         IWORK, LIWORK,  LINFO )
      ENDIF
      DEALLOCATE(WORK, IWORK, STAT=ISTAT1)
   ENDIF
   CALL ERINFO(INT(LINFO,4),SRNAME,INFO,ISTAT)
END SUBROUTINE LA_SYEVD
