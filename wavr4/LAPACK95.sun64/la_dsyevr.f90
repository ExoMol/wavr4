SUBROUTINE  LA_SYEVR( A, W, JOBZ, UPLO, VL, VU, IL, IU, M, ISUPPZ, ABSTOL, INFO )
!
...
!  .. USE STATEMENTS ..
      ...
      ! USE F77_LAPACK, ONLY: DSYEVR
      ! USE SUNPERF, ONLY: DSYEVR
!  .. IMPLICIT STATEMENT ..
      IMPLICIT NONE
!  .. CHARACTER ARGUMENTS ..
...
!  .. LOCAL SCALARS ..
      ...
      INTEGER :: LZ, ISTAT, NN
      INTEGER(8) :: N, LINFO, LD, LDZ, LIL, LIU, LM, LWORK, &
     &  LIWORK, SISUPPZ
      INTEGER(8) :: IWORKMIN(1)
      REAL(WP) :: WORKMIN(1)
      REAL(WP) :: LABSTOL, LVL, LVU
!  .. LOCAL ARRAYS ..
      INTEGER(8), POINTER :: IWORK(:), LISUPPZ(:)
...
!  .. QUERING THE SIZE OF WORKSPACE ..
            LWORK = -1
            LIWORK = -1
              CALL DSYEVR_64( LJOBZ, LRANGE, LUPLO, N, A, LD, LVL, LVU, &
...
200           DEALLOCATE(IWORK)
         ENDIF
100         CALL ERINFO(INT(LINFO,4),SRNAME,INFO,ISTAT)
END SUBROUTINE LA_SYEVR
