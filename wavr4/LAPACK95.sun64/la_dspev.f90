SUBROUTINE LA_SPEV( A, W, UPLO, Z, INFO )
!
...
!  .. USE STATEMENTS ..
   ...
   ! USE F77_LAPACK, ONLY: DSPEV
   ! USE SUNPERF, ONLY: DSPEV
!  .. IMPLICIT STATEMENT ..
   IMPLICIT NONE
!  .. CHARACTER ARGUMENTS ..
...
!  .. LOCAL SCALARS ..
   ...
   INTEGER :: NN, LD, ISTAT, ISTAT1, S1Z
   INTEGER(8) :: N, LINFO, S2Z
   COMPLEX(WP) :: WW
!  .. LOCAL ARRAYS ..
...
!  .. DETERMINE THE WORKSPACE
   ...
   !     .. CALL LAPACK77 ROUTINE
          CALL DSPEV_64( LJOBZ, LUPLO, N, A, W, Z, S2Z, WORK, LINFO )
	 ELSE
	  CALL DSPEV_64( LJOBZ, LUPLO, N, A, W, LLZ, S2Z, WORK, LINFO )
	 ENDIF
      ELSE; LINFO = -100; ENDIF
      DEALLOCATE(WORK,STAT=ISTAT1)
   ENDIF
   CALL ERINFO(INT(LINFO,4),SRNAME,INFO,ISTAT)
END SUBROUTINE LA_SPEV
